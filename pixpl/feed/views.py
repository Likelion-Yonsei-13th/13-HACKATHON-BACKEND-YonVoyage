...
from .serializers import FeedCreateSerializer, FeedDetailSerializer, PickToggleSerializer
...
class FeedView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            # Serializer로 Response 반환
            detail_serializer = FeedDetailSerializer(feed, context={'user': user})
    ...
    def get(self, request):
        ...
        serializer = FeedDetailSerializer(feeds, many=True, context={'user': user})
        return Response({
...
class FeedDetailView(APIView):
    ...
    def delete(self, request, feed_id):
        ...
        feed.delete()
        return Response({"message": "피드가 성공적으로 삭제되었습니다."}, status=status.HTTP_200_OK)
